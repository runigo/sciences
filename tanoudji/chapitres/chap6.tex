...
\[
\Lambda_\pm(\vec{\mt{r}}\,)=\mt{e}^{\mt{i}\vec{\mt{k}}_\mt{i}\vec{\mt{r}}}
+ \mt{f}_\pm(\vec{\mt{k}}_\mt{i},\,\theta,\,\phi)\ \frac{\mt{e}^{\pm}\mt{i k}_\mt{i}\mt{r}}{r}
...
Nous allons montrer que  est l'état que L'on obtient

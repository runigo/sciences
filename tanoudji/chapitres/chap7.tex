...
\begin{center} \begin{tikzpicture}
\draw [dashed, gray] (2,5) -- (2,0) node [below, black] {$\omega$};
\draw [very thick] (0.1,0.2) .. controls +(1.9,0.1) and +(-0.3, 0) .. (2,2);	% montée - sommet	1
\draw [very thick] (2,2) .. controls +(0.3,0) and +(-1,0.1) .. (3.5,0.6);	% sommet - interm	1
\draw [very thick] (3.5,0.6) .. controls +(1,-0.1) and +(-6,0.1) .. (15,0.1);% interm - fin		1
\draw [dashed, gray] (6,5) -- (6,0) node [below, black] {$3\omega$};
\draw [very thick] (0.1,1.5) .. controls +(1.3,0.2) and +(-0.3, 0) .. (1.9,2.5);	% montée - sommet 1
\draw [very thick] (1.9,2.5) .. controls +(0.3,0) and +(-1.5,0.15) .. (3.9,1.5);	% sommet 1 - interm 1
\draw [very thick] (3.9,1.5) .. controls +(2,-0.2) and +(-0.2,0) .. (5.9,2.4);	% interm 1 - sommet 2
\draw [very thick] (5.9,2.4) .. controls +(0.2,0) and +(-1,0.1) .. (7,1.4);	% sommet 2 - interm 2
\draw [very thick] (7,1.4) .. controls +(1,-0.1) and +(-6,0.1) .. (15,1);	% interm 2 - fin 2
\draw [dashed, gray] (10,5) -- (10,0) node [below, black] {$5\omega$};
\draw [very thick] (0.1,2.6) .. controls +(1.3,0.2) and +(-0.5, 0) .. (1.7,3);	% montée - sommet 1
\draw [very thick] (1.7,3) .. controls +(0.5,0) and +(-1.5,0.15) .. (3.5,2.6);	% sommet 1 - interm 1
\draw [very thick] (3.5,2.6) .. controls +(1.5,-0.15) and +(-0.4,0) .. (5.7,3.1);	% interm 1 - sommet 2
\draw [very thick] (5.7,3.1) .. controls +(0.4,0) and +(-2,0.2) .. (8,2.4);	% sommet 2 - interm 2
\draw [very thick] (8,2.4) .. controls +(2,-0.2) and +(-0.2,-0.2) .. (9.8,3);	% interm 2 - sommet 3
\draw [very thick] (9.8,3) .. controls +(0.2,-0.2) and +(-1.5,0.15) .. (11,2.3);	% sommet 3 - interm 3
\draw [very thick] (11,2.3) .. controls +(1,-0.1) and +(-1,0.1) .. (15,2);	% interm 3 - fin 3
\draw [dashed, gray] (14,5) -- (14,0) node [below, black] {$7\omega$};
\draw [very thick] (0.1,4) .. controls +(0.7,0.2) and +(-0.5, 0) .. (1.5,4.3);	% montée - sommet 1
\draw [very thick] (1.5,4.3) .. controls +(0.5,0) and +(-1.4,0.1) .. (3.5,4.1);	% sommet 1 - interm 1
\draw [very thick] (3.5,4.1) .. controls +(1.4,-0.1) and +(-0.5,0) .. (5.5,4.3);	% interm 1 - sommet 2
\draw [very thick] (5.5,4.3) .. controls +(0.5,0) and +(-2,0.2) .. (8,3.9);	% sommet 2 - interm 2
\draw [very thick] (8,3.9) .. controls +(1,-0.1) and +(-0.5,0) .. (9.7,4.2);	% interm 2 - sommet 3
\draw [very thick] (9.7,4.2) .. controls +(0.5,0) and +(-1.5,0.15) .. (12,3.6);	% sommet 3 - interm 3
\draw [very thick] (12,3.6) .. controls +(1.5,-0.15) and +(-0.01,0.01) .. (13.8,4.2);	% interm 3 - sommet 4
\draw [very thick] (13.8,4.2) .. controls +(0.01,-0.01) and +(-1,0.1) .. (15,3.4);	% sommet 4 - fin 4
...
\begin{center} \begin{tikzpicture}
%\draw [dashed, gray] (2,5) -- (2,0) node [below, black] {$\omega$};
\draw [thick] (2,1) -- (-2,1) node [left] {$+1/2$};
\draw [thick] (2,-1) -- (-2,-1) node [left] {$-1/2$};
\draw (-1,0) node [left] {$\omega_0=\omega$};
\draw [dashed, <->] (-1,0.95) -- (-1,-0.95);
\draw [-{Classical TikZ Rightarrow[length=2mm]}] (0,-1) -- (0,1);
\draw (0,0) node [right] {$\sigma_+$};
\end{tikzpicture} \end{center}
\end{minipage}
\hfill
\begin{minipage}[c]{.45\linewidth}
\begin{center} \begin{tikzpicture}
%\draw [dashed, gray] (2,5) -- (2,0) node [below, black] {$\omega$};
\draw [thick] (2,3) -- (-2,3) node [left] {$+1/2$};
\draw [thick] (2,-3) -- (-2,-3) node [left] {$-1/2$};
\draw (-1,0) node [left] {$\omega_0=3\,\omega$};
\draw [dashed, <->] (-1,2.95) -- (-1,-2.95);
\draw [-{Classical TikZ Rightarrow[length=2mm]}] (0,1) -- (0,3);
\draw (0,2) node [right] {$\sigma_+$};
\draw [dashed, -{Classical TikZ Rightarrow[length=2mm]}] (0,-1) -- (0,1);
\draw (0,0) node [right] {$\sigma_-$};
\draw [-{Classical TikZ Rightarrow[length=2mm]}] (0,-3) -- (0,-1);
\draw (0,-2) node [right] {$\sigma_+$};
\end{tikzpicture} \end{center}
\end{minipage}
...
\subsection{Hamiltonien du système "spin-radiofréquence"}% 2
...
$\vec{e}_\mt{x}$ étant Le vecteur unitaire le long de Ox et $\alpha$ une constante de proportionnalité
...
D'après la propriété fondamentale de l'état $|\ \psi >$, la valeur moyenne dans cet état de
...
\subsection{Etude des niveaux d'énergie de $\mc{H}_0$}%3
...
%%%%- 219 
Le couplage $\lambda$J$_\mt{x }($a$+$a$^+)$ possède des éléments de matrice non nuls
...
\subsection{Principe du calcul des formes de raie des transitions à plusieurs quanta}%4
...
Nous nous bornerons de plus à un calcul de perturbation \ul{à l'ordre
...
\subsection{Transition à un quantum : Shift de Bloch et Siegert}%5
...
\ul{Remarque} : L'état du champ de rayonnement n'est pas un état $|$ n $>$, mais une superposition
...
\subsection{Transition à trois quanta : ($\omega_0=3\omega$)}% 6
...
%%%% 224
Or le niveau $|$ a $>\;=|$ n$+3\,,\ ->$ est relié au premier ordre aux
